        ...
        public override void Decode()
        {
            ...
            for (var ty = 0; ty < rectangle.Height; ty += 16)
            {
                ...
                for (var tx = 0; tx < rectangle.Width; tx += 16)
                {
                    ...
                    if ((subencoding & RAW) != 0) FillRectangle(new Rectangle(tx, ty, tw, th));
                    else
                    {
                        ...
                        if ((subencoding & ANY_SUBRECTS) != 0)
                        {
                            ...
                            {
                                if ((subencoding & SUBRECTS_COLOURED) != 0) foregroundPixelValue = preader.ReadPixel(); // colour of this sub rectangle
