...
namespace ComponentAce.Compression.Libs.zlib
{
    public sealed class Deflate
    {
        ...
        {
                "need dictionary", "stream end", "", "file error", "stream error", "data error", "insufficient memory", "buffer error",
        ...
        internal bool _tr_tally(int dist, int lc)
        {
            ...
            if ((last_lit & 0x1fff) == 0 && level > 2)
            {
                ...
                int dcode;
                for (dcode = 0; dcode < D_CODES; dcode++) out_length = (int)(out_length + dyn_dtree[dcode * 2] * (5L + Tree.extra_dbits[dcode]));
        ...
        internal int build_bl_tree()
        {
            ...
            for (max_blindex = BL_CODES - 1; max_blindex >= 3; max_blindex--) if (bl_tree[Tree.bl_order[max_blindex] * 2 + 1] != 0) break;
        ...
        internal int deflateInit2(ZStream strm, int level, int method, int windowBits, int memLevel, int strategy)
        {
            ...
            if (memLevel < 1 || memLevel > MAX_MEM_LEVEL || method != Z_DEFLATED || windowBits < 9 || windowBits > 15 || level < 0 || level > 9 || strategy < 0 ||
                strategy > Z_HUFFMAN_ONLY) return Z_STREAM_ERROR;
        ...
        internal int longest_match(int cur_match)
        {
            ...
            do
            {
                ...
                do { } while (window[++scan] == window[++match] && window[++scan] == window[++match] && window[++scan] == window[++match] && window[++scan] == window[++match] &&
        ...
        internal void scan_tree(short[] tree, int max_code)
        {
            ...
            for (n = 0; n <= max_code; n++)
            {
                ...
                if (count < min_count) bl_tree[curlen * 2] = (short)(bl_tree[curlen * 2] + count);
                else if (curlen != 0)
                {
