    ...
    public class ZOutputStream : Stream
    {
        ...
        public virtual void finish()
        {
            ...
            do
            {
                ...
                z.next_out_index = 0;
                z.avail_out = bufsize;
                if (compress) err = z.deflate(zlibConst.Z_FINISH);
                else err = z.inflate(zlibConst.Z_FINISH);
                if (err != zlibConst.Z_STREAM_END && err != zlibConst.Z_OK) throw new ZStreamException((compress ? "de" : "in") + "flating: " + z.msg);
        ...
        public override void Write(byte[] b1, int off, int len)
        {
            ...
            do
            {
                ...
                z.next_out_index = 0;
                z.avail_out = bufsize;
                if (compress) err = z.deflate(flush_Renamed_Field);
                else err = z.inflate(flush_Renamed_Field);
                if (err != zlibConst.Z_OK && err != zlibConst.Z_STREAM_END) throw new ZStreamException((compress ? "de" : "in") + "flating: " + z.msg);
