...
namespace ComponentAce.Compression.Libs.zlib
{
    public class SupportClass
    {
        ...
        /// </param>
        /// <returns>
        ///     The number of characters read. The number will be less than or equal to count depending on the data available in the source Stream. Returns -1 if the end of the
        ///     stream is reached.
        /// </returns>
        public static int ReadInput(Stream sourceStream, byte[] target, int start, int count)
        {
            ...
            for (var i = start; i < start + bytesRead; i++) target[i] = receiver[i];
        ...
        /// </param>
        /// <returns>
        ///     The number of characters read. The number will be less than or equal to count depending on the data available in the source TextReader. Returns -1 if the end of
